#!/usr/bin/env python
# coding: utf-8
"""Single-core export of the five runtime benchmark AnnData files for CACOA and miloDE.
...
# ------------------------------------------------------------
data_dir = Path(
    "/home/anilprakash/labs/Mei/projects/anil/srda/notebooks/data/"
    "scrna_seq/simulation"
)

manifest_file = data_dir / "simulation_manifest_runtime_5_cell_counts.csv"

export_dir = data_dir / "cacoa_milode_exports_runtime_5_cell_counts"
...
def main():
    ...
    export_manifest_file = export_dir / "cacoa_milode_export_manifest_runtime_5_cell_counts.csv"
