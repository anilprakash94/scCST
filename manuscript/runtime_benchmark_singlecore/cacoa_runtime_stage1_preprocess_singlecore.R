...
manifest_file <- file.path(export_dir, "cacoa_milode_export_manifest_runtime_5_cell_counts.csv")
...
manifest_out <- file.path(preprocess_dir, "cacoa_runtime_preprocess_manifest.csv")
